...
public class Debuger : EditorWindow
{
	...
	//	if (GUILayout.Button("+", GUILayout.Width(20))) Form.FormLevelController.LevelUp();
	//	if (GUILayout.Button("0", GUILayout.Width(20))) Form.FormLevelController.SetupLevel(0);
	//	if (GUILayout.Button("-", GUILayout.Width(20))) Form.FormLevelController.LevelDown();
	//	GUILayout.Label(Form.FormLevelController.Level.ToString(), GUILayout.MaxWidth(40));
